...
#define add_floatn(clss,meth,n) class_addmethod(clss, (t_method)meth,gensym("ft" #(n+1)),A_FLOAT,A_NULL)
#define add_flint(clss,meth) class_addfloat(clss, (t_method)meth)
#define add_flintn(clss,meth,n) class_addmethod(clss, (t_method)meth,gensym("ft" #(n+1)),A_FLOAT,A_NULL)
...
#define add_floatn(clss,meth,n) addftx((method)meth,n+1)
#define add_flint(clss,meth) addint((method)meth)
#define add_flintn(clss,meth,n) addinx((method)meth,n+1)
