...
#define add_flint(clss,meth) class_addmethod(clss, (method)meth, const_cast<char *>("int"), A_LONG, A_NOTHING)
#define add_flintn(clss,meth,n) class_addmethod(clss, (method)meth, const_cast<char *>("in" #n), A_LONG, A_NOTHING)
